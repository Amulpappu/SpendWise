...
object GoogleSheetsSyncManager {
    ...
    const val DEFAULT_WEBHOOK_URL = "https://script.google.com/macros/s/AKfycbyvvndQsIPGPpsjSm3ilauC2aXpa0eW3lkyFHwBPmUibYeHYrkskJcJNE47NcWcELehog/exec"
    ...
    fun getWebhookUrl(context: Context): String {
        ...
        return if (saved.isNullOrBlank() || saved.contains("AKfycbyUbZ61_7UnASiyLV") || saved.contains("AKfycbxec14GhgurG284NGRX2k0yBK6dU9TdkhL0csLbkNlomClA9_2AGGVmOLBFE4HH0qHt")) DEFAULT_WEBHOOK_URL else saved
    }
